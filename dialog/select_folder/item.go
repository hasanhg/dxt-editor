...
type selectFolderDialogItem struct {
	widget.BaseWidget
	picker    *selectFolderDialog
	isCurrent bool
...
func (i *selectFolderDialogItem) MouseIn(*desktop.MouseEvent) {
	i.hovered = true
	i.Refresh()
}

func (i *selectFolderDialogItem) MouseMoved(*desktop.MouseEvent) {
}

func (i *selectFolderDialogItem) MouseOut() {
	i.hovered = false
	i.Refresh()
}

func (i *selectFolderDialogItem) Tapped(_ *fyne.PointEvent) {
	i.picker.setSelected(i)
	i.Refresh()
}

func (i *selectFolderDialogItem) CreateRenderer() fyne.WidgetRenderer {
...
func (i *selectFolderDialogItem) isDirectory() bool {
	return i.dir
}

func (f *selectFolderDialog) newFileItem(location fyne.URI, dir bool) *selectFolderDialogItem {
	item := &selectFolderDialogItem{
		picker:   f,
		location: location,
		dir:      dir,
	}

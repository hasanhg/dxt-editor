...
func (i *saveDialogItem) MouseIn(*desktop.MouseEvent) {
	i.hovered = true
	i.Refresh()
}

func (i *saveDialogItem) MouseMoved(*desktop.MouseEvent) {
}

func (i *saveDialogItem) MouseOut() {
	i.hovered = false
	i.Refresh()
}

func (i *saveDialogItem) Tapped(_ *fyne.PointEvent) {
	i.picker.setSelected(i)
	i.Refresh()
}

func (i *saveDialogItem) CreateRenderer() fyne.WidgetRenderer {
...
func (i *saveDialogItem) isDirectory() bool {
	return i.dir
}

func (f *saveDialog) newFileItem(location fyne.URI, dir bool) *saveDialogItem {
	item := &saveDialogItem{
		picker:   f,
		location: location,
		dir:      dir,

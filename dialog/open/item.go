...
func (i *openDialogItem) MouseIn(*desktop.MouseEvent) {
	i.hovered = true
	i.Refresh()
}

func (i *openDialogItem) MouseMoved(*desktop.MouseEvent) {
}

func (i *openDialogItem) MouseOut() {
	i.hovered = false
	i.Refresh()
}

func (i *openDialogItem) Tapped(_ *fyne.PointEvent) {
	i.picker.setSelected(i)
	i.Refresh()
}

func (i *openDialogItem) CreateRenderer() fyne.WidgetRenderer {
...
func (i *openDialogItem) isDirectory() bool {
	return i.dir
}

func (f *openDialog) newFileItem(location fyne.URI, dir bool) *openDialogItem {
	item := &openDialogItem{
		picker:   f,
		location: location,
		dir:      dir,
